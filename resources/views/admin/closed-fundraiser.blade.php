...
<head>
    ...
    <title>Mouliya Admin - Closed Fundraiser</title>
    <!-- Favicon -->
        ...
        <div class="modal fade " id="default1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
              <p>Do you want to make this fundraising to active!</p>
              </div>
              <div class="modal-footer">
        ...
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
              ...
              <li class="active nav-item"><a href="closed-fundraiser.html"><i class="icon-notebook"></i><span data-i18n="" class="menu-title">Closed Fundraisers</span></a>
              </li>
                        ...
                        <table class="table  zero-configuration table-responsive">
                            <thead>
                                <tr>  
                                  ...
                                  <th class="border-top-0">Date Open</th>
                                  <th class="border-top-0">Date Closed</th>
                            ...
                            <tbody>
                                <tr>
                                  ...
                                  <td>
                                        <a href="view-closed-fundraiser.html" class="color-black p-0" data-original-title="" title="View">
