...
<head>
    ...
    <title>Mouliya Admin - Edit User</title>
    <!-- Favicon -->
        ...
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
              ...
              <li class="active nav-item"><a href="users.html"><i class="icon-users"></i><span data-i18n="" class="menu-title">Users</span></a>
              </li>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <p class="mb-0 mt-2">You can edit the user details here.</p>
        </div>
        <div class="card-body">
          <div class="px-3">
                ...
                <div class="col-md-6">
                  <div class="form-body">
                    ...
                    <div class="form-group">
                      <label for="eventInput2">Full Name</label>
                      <input type="text" id="eventInput2" class="form-control" name="title">
                    </div>
                    <div class="form-group">
                      <label for="eventInput2">Email</label>
                      <input type="email" id="eventInput2" class="form-control" name="title">
                    </div>
                    <div class="form-group">
