...
<head>
    ...
    <title>Mouliya Admin - View Website Message</title>
    <!-- Favicon -->
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                        <ul class="no-list-style">
                                                            <li class="mb-2">
                                                                <span class="text-bold-500 primary"><a class="color-light-black"> Name:</a></span>
                                                                <span class="display-block overflow-hidden">Faizan</span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                        <ul class="no-list-style">
                                                            <li class="mb-2">
                                                                <span class="primary text-bold-500"><a class="color-light-black">Telephone:</a></span>
                                                                <span class="line-height-2 display-block overflow-hidden">092 123 456 7892</span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                        <ul class="no-list-style">
                                                            <li class="mb-2">
                                                                <span class="primary text-bold-500"><a class="color-light-black">Email</a></span>
                                                                <span class="line-height-2 display-block overflow-hidden">Faizan@example.com </span>
                                                            </li>
