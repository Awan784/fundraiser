        ...
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
              ...
              <li class="active nav-item"><a href="website-messages.html"><i class="icon-support"></i><span data-i18n="" class="menu-title">Contact Us</span></a>
              </li>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <ul class="no-list-style pl-0">
                                    <li class="mb-2">
                                        <span class="text-bold-500 primary"><a class="color-light-black"> Full Name:</a></span>
                                        <span class="display-block overflow-hidden">Mouctar Blah</span>
                                    </li>
                                    <li class="mb-2">
                                        <span class="text-bold-500 primary"><a class="color-light-black">Email:</a></span>
                                        <span class="display-block overflow-hidden">MouctarBlah@example.com</span>
                                    </li>
                                    <li class="mb-2">
