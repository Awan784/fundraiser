...
<head>
    ...
    <title>Mouliya Admin - Website Messages</title>
    <!-- Favicon -->
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title-wrap bar-success">
                                    <h4 class="card-title">Website Messages list</h4>
                                </div>
                            </div>
                                    ...
                                    <table class="table  zero-configuration table-responsive12">
                                        ...
                                        <tbody>
                                            <tr>
                                              ...
                                              <td>
                                                    <button type="button" class="btn btn-sm btn-outline-warning round">Resolved</button>
                                                </td>
                                              <td>
                                                    <a href="view-website-message.html" class="color-black p-0" data-original-title="" title="View">
