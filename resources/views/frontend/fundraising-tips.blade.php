...
<body class="index-bus1">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    <div class="caption text-center">
                        <h1 class="fz-50 fw-600 text-main-color">Fundraising Tips</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="main-post md-mb50">
                    <div class="item pb-60">
                        ...
                        <div class="title mb-30">
                            <h6 class="fw-600 mb-15">Apple currently sells only one MacBook Air size.</h6>
                        </div>
                        ...
                        <div class="text mb-30">
                            <p class="mb-10">A new report said earlier this week that Apple is working on a brand new laptop.
                                Apple plans to release a 15-inch MacBook Air in 2023, a first for the Air
                                series. A trusted Apple insider with a proven track record confirmed that Apple
                                is working on the larger MacBook Air.</p>
                                <p>A new report said earlier this week that Apple is working on a brand new laptop.
    ...
    <footer class="main-footer bg-dark-blue bg-img" data-background="frontend/assets/img/background/8.jpg" data-overlay-dark="0" style="background-image: url(&quot;frontend/assets/img/background/8.jpg&quot;);">
