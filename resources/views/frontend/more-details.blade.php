...
<head>
    ...
    <!-- Title  -->
    <title>Mouliya - Fundraiser More Details</title>
...
<body class="index-restaurant">
   ...
   <!-- ==================== Start progress-scroll-button ==================== -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="how-works.html">    How GoFundMe Works</a></li>
                ...
                <div class="social">
                    <ul class="rest">
                        <li>
                            <a href="gofund.html" class="butn butn-md bg-dark-brown radius-30">
    ...
    <div id="particles-js" ></div>
        ...
        <!-- ==================== Start Blog ==================== -->
    <section class="process-simp position-re shad-up mt-170">
        <div class="simple-head md-mb10 mb-80 text-center">
            <h2 class="fz-40 fw-800 text-main-color inline">SOS Medical Fundraisers List</h2>
                    ...
                    <div class="search-form mt-30">
                        <form action="#">
                            <div class="form-group">
                                <input type="text" name="search" placeholder="Search for specific fundraiser">
                            </div>
                        </form>
                    </div>
                </div>
   ...
   <section class="menu-book tabs pb-100" data-scroll-index="2">
            <div class="container">
                    ...
                    <div class="col-12">
                        <div class="position-re">
                            <div class="tab-content current" id="tab-1">
                                <div class="row">
                                    <div class="col-lg-12 md-mb40">
                                        <div class="menu-list mb-40">
                                            <div class="item">
                                                <div class="flex mb-5">
                                                    <h5 class="title fz-16 fw-600 text-u ls2">Faizan Saeed
                                                    </h5>
                                                    <div class="dots"></div>
                                                    <h6 class="price">10.000.000GNF</h6>
                                                </div>
                                                <p>9 January 2023 - 09:30 pm - Guinea - Africa</p>
                                                <p>( Good Luck for your mission )</p>
                                            </div>
                                        </div>
                                        <div class="menu-list mb-40">
                                            <div class="item">
                                                <div class="flex mb-5">
                                                    <h5 class="title fz-16 fw-600 text-u ls2">Mouchtar Blah
                                                    </h5>
                                                    <div class="dots"></div>
                                                    <h6 class="price">10.000.000GNF</h6>
                                                </div>
                                        ...
                                        <div class="menu-list mb-40">
                                            <div class="item">
                                                ...
                                                <p>9 January 2023 - 09:30 pm - Punjab - Pakistan</p>
                                                <p>( Good Luck for your mission )</p>
