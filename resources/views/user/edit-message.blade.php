...
<head>
    ...
    <title>Mouliya Admin - Communications</title>
    <!-- Favicon -->
        ...
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
              ...
              <li class="active nav-item"><a href="messages.html"><i class="icon-speech"></i><span data-i18n="" class="menu-title">Communications</span></a>
              </li>
                    ...
                    <div class="card">
                      <div class="card-header">
                        <div class="card-title-wrap bar-warning">
                          <h4 class="card-title" id="horz-layout-colored-controls">Edit Communications</h4>
                        </div>
                        <p class="mb-0 mt-2">You can do the edit Communication here.</p>
                      </div>
                      <div class="card-body">
                        <div class="px-3">
                          ...
                          <form class="form">
                              ...
                              <div class="col-md-6">
                                <div class="form-body">
                                  ...
                                  <div class="form-group">
                                    <label for="eventInput2">Select Fundraiser</label>
                                    <select id="projectinput5" name="interested" class="form-control">
                                            <option value="design">SOS Medical 1</option>
                                            <option value="development">SOS Medical 2</option>
                                            <option value="illustration">SOS Medical 3</option>
                                            <option value="branding">SOS Medical 4</option>
                                            <option value="video">SOS Medical 5</option>
                                          </select>
                                  </div>
                                  <div class="form-group">
                                    <label for="eventInput2">Title</label>
                                    <input type="text" id="eventInput2" class="form-control" placeholder="Enter message title here" name="title">
                                  </div>
                                  <div class="form-group">
                                    <label for="eventInput2">Communications</label>
                            ...
                            <div class="form-actions center">
                              ...
                              <a href="messages.html"  class="btn btn-success">
                                Edit
                              </a>
                            </div>
                          </form>
