...
<head>
    ...
    <title>Mouliya Admin - Edit Closed Fundraiser</title>
    <!-- Favicon -->
        ...
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
              ...
              <li class="active nav-item"><a href="closed-user-fundraiser.html"><i class="icon-notebook"></i><span data-i18n="" class="menu-title">Closed Fundraisers</span></a>
              </li>
      ...
      <div class="card">
        <div class="card-header">
          <div class="card-title-wrap bar-warning">
            <h4 class="card-title" id="horz-layout-colored-controls">Edit Closed Fundraising</h4>
          </div>
          <p class="mb-0 mt-2">You can edit the closed fundraising details here.</p>
        </div>
        <div class="card-body">
          <div class="px-3">
                ...
                <div class="row ">
                  <div class="col-md-6 mt-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="eventInput2" class="form-control" name="title" placeholder="MFTX000001" disabled>
                    </div>
                    <div class="form-group">
                      <label for="eventInput2">What country are you in? </label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="eventInput2" class="form-control" name="title" placeholder="Street # 1, house # 1 , Guinea, Africa" >
                    </div>
                    <div class="form-group">
                  ...
                  <div class="col-md-6 mt-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="eventInput2" class="form-control" name="title" placeholder="MFTX000001">
                    </div>
                    <div class="form-group">
                      <label for="eventInput2">What is your initial goal amount to raise? </label>
                      <input type="text" id="eventInput2" class="form-control" name="title" placeholder="3.00.000.000 GNF" >
                    </div>
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <textarea id="donationinput7" rows="2" class="form-control square" name="comments"></textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <textarea id="donationinput7" rows="4" class="form-control square" name="comments"></textarea>
                    </div>
                  </div>
                </div>
