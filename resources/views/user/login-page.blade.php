...
<head>
    ...
    <title>Mouliya User Login</title>
                ...
                <div class="card py-2 box-shadow-2 width-400" style="position:relative;">
                    ...
                    <div class="card-body">
                        <div class="card-block">
                            ...
                            <div class="text-center mt-2"><a href="forgot-password.html" class="color-green-light">Forgot your password ? </a> </div>
                    ...
                    <div class="card-footer grey darken-1">
                            <div class="text-center">Don't have an account ?  <a href="create-an-account.html" class="color-green-light"> Create an account </a></div>
                        </div>
