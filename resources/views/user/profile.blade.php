...
<head>
    ...
    <title>Mouliya Admin - Profile</title>
    <!-- Favicon -->
        ...
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
              ...
              <li class="active nav-item"><a href="profile.html"><i class="icon-users"></i><span data-i18n="" class="menu-title">Profile</span></a>
              </li>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                        <ul class="no-list-style">
                                                            <li class="mb-2">
                                                                ...
                                                                <span class="display-block overflow-hidden">Faizan Saeed</span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                                        <ul class="no-list-style">
                                                            <li class="mb-2">
                                                                ...
                                                                <span class="line-height-2 display-block overflow-hidden">+224 628 68 62 34</span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                              ...
                              <div class="col-md-6">
                                <div class="form-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="password" id="eventInput2" class="form-control" name="title">
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="password" id="Confimr New Password" class="form-control" name="title">
                                  </div>
